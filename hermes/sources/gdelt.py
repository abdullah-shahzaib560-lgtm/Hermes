...
EVENT_THEMES: dict[str, list[str]] = {
    "PROTEST": ["PROTEST", "TAX_FNCACT_Protest", "TAX_FNCACT_Riot",
                "GENERAL_CRISIS_RIOTPROTEST", "SOC_RIOT"],
    "CONFLICT": ["CONFLICT", "GENERAL_CONFLICT", "MAR_EVENT_MILITARY",
                 "TAX_FNCACT_Assault", "TAX_FNCACT_Fight"],
    "DIPLOMACY": ["DIPLOMACY", "TAX_FNCACT_Diplomacy", "TAX_FNCACT_Agree",
                  "TAX_FNCACT_Endorse"],
...
COUNTRIES_ISO3 = [
    ...
    "BOL","BIH","BWA","BRA","BRN","BGR","BFA","MMR","BDI","KHM",
    ...
    "IRL","ISR","ITA","JAM","JPN","JOR","KAZ","KEN","KIR","KOR",
    "XKX","KWT","KGZ","LAO","LVA","LBN","LSO","LBR","LBY","LIE",
    "LTU","LUX","MKD","MDG","MWI","MYS","MDV","MLI","MLT","MHL",
    "MRT","MUS","MEX","FSM","MDA","MNG","MNE","MAR","MOZ","NAM",
    ...
    "ESP","LKA","SDN","SUR","SWZ","SWE","CHE","SYR","TJK","TZA",
    "THA","TLS","TGO","TON","TTO","TUN","TUR","TKM","TUV","UGA",
    "UKR","ARE","GBR","USA","URY","UZB","VUT","VAT","VEN","VNM",
    "YEM","ZMB","ZWE",
]
FIPS = [
    "AF","AL","AG","AN","AO","AC","AR","AM","AS","AU",
    "AJ","BF","BA","BG","BB","BO","BE","BH","BN","BT",
    "BL","BK","BC","BR","BX","BU","UV","BM","BY","CB",
    "CM","CA","CV","CT","CD","CI","CH","CO","CN","CF",
    "CG","CS","IV","HR","CU","CY","EZ","DA","DJ","DO",
    "DR","EC","EG","ES","EK","ER","EN","ET","FJ","FI",
    "FR","GB","GA","GG","GM","GH","GR","GJ","GT","GV",
    "PU","GY","HA","HO","HU","IC","IN","ID","IR","IZ",
    "EI","IS","IT","JM","JA","JO","KZ","KE","KR","KS",
    "KV","KU","KG","LA","LG","LE","LT","LI","LY","LS",
    "LH","LU","MK","MA","MI","MY","MV","ML","MT","RM",
    "MR","MP","MX","FM","MD","MN","MJ","MO","MZ","WA",
    "NR","NP","NL","NZ","NU","NG","NI","NO","MU","PK",
    "PW","PM","PP","PA","PE","RP","PL","PO","QA","RO",
    "RS","RW","SC","ST","VC","WS","SM","TP","SA","SG",
    "RI","SE","SL","SN","LO","SI","BP","SO","SF","OD",
    "SP","CE","SU","NS","WZ","SW","SZ","SY","TI","TZ",
    "TH","TT","TO","TN","TD","TS","TU","TX","TV","UG",
    "UP","AE","UK","US","UY","UZ","NH","VT","VE","VM",
    "YM","ZA","ZI",
]
    ...
    def _to_canonical(df: pd.DataFrame) -> pd.DataFrame:
        ...
        if "date" in df.columns:
            ...
            out["date"] = pd.to_datetime(
                df["seendate"].str[:14], format="%Y%m%d%H%M%S", errors="coerce"
            )
        ...
        if "themes" in df.columns:
            ...
            _CAMEO = {
                0:"statement",1:"yield",2:"comment",3:"consult",
                4:"diplomatic_cooperation",5:"material_cooperation",
                6:"provide_aid",7:"grant_asylum",8:"endorse",9:"agree",
                10:"demand",11:"disapprove",12:"reject",13:"threaten",
                14:"protest",15:"display_force",16:"reduce_relations",
                17:"sanction",18:"assault",19:"fight",20:"mass_violence",
            }
